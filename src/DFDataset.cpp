...
#if defined(ESP8266) || defined(ESP32) || defined(ARDUINO_UNOWIFIR4)
// ISRG Root X1 (Let's Encrypt) certificate, expires 2035-06-04
static const char kIsrgRootX1[] =
  "-----BEGIN CERTIFICATE-----\n"
...
#ifdef ESP8266
static BearSSL::X509List kIsrgRootX1Cert(kIsrgRootX1);
#endif
...
void DFDataset::ensureTlsConfigured() {
  ...
  #if defined(ESP8266)
  wifi.setTrustAnchors(&kIsrgRootX1Cert);
  #else
  wifi.setCACert(kIsrgRootX1);
  #endif
